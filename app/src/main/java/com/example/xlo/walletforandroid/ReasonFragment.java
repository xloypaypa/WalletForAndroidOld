...
public class ReasonFragment extends Fragment {
	...
	private void loadData() {
        try{
            ...
            for (int i=0;i<a.size();i++){
                ...
                ReasonType now= (ReasonType) a.get(i);
                name.setText(now.getName());
                income.setText(now.getIncome()+"");
                expenditure.setText(now.getExpenditure() + "");
	...
	private void loadItem() {
		add=(Button) this.getActivity().findViewById(R.id.reason_action_add);
		rename=(Button) this.getActivity().findViewById(R.id.reason_action_rename);
		remove=(Button) this.getActivity().findViewById(R.id.reason_action_remove);
		normal=(TableLayout) this.getActivity().findViewById(R.id.reason_normal_table);
	};
}
